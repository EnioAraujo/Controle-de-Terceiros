...
| 2026-03-26 | Migration enforce_mfa_aal2.sql: função public.is_aal2() criada (em public, não auth — SQL Editor não tem permissão no schema auth); todas as políticas de escrita (INSERT/UPDATE/DELETE) em registros, opcoes, audit_log, diarias_config, fechamento_itens, fechamentos, terceiros, turnos_config e profiles agora exigem sessão AAL2 (TOTP verificado) |
