...
| 2026-03-26 | Migration enforce_mfa_aal2.sql: função auth.is_aal2() criada; todas as políticas de escrita (INSERT/UPDATE/DELETE) em registros, opcoes, audit_log, diarias_config, fechamento_itens, fechamentos, terceiros, turnos_config e profiles agora exigem sessão AAL2 (TOTP verificado) |
